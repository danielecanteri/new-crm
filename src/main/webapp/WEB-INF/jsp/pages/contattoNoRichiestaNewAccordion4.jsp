...
<div class="well well-small" style="margin-bottom: 2px"
	...
	<div ng-show="!collapsed.infoBancario">
		<form ng-submit="doSearchBancario()" class="form-search" style="margin: 0px">
			<fieldset>
				...
				<input style="margin-bottom: 2px" class="span5" type="text"
					placeholder="cognome nome" ng-model="nomeCognomeBancario"
					ng-submit="doSearchBancario()"> <input
					style="margin-bottom: 2px" class="span2" type="text"
					placeholder="ABI" ng-model="abi"> <input class="span2"
	...
	<div ng-show="collapsed.infoBancario">
		<div ng-show="bancario != null">
			<i class="icon-remove pull-right" ng-click="bancario = null; collapsed.infoBancario = false"></i>
			<div class="row-fluid">
				<div class="span3" style="min-height: 0px">
					<b>Bancario: </b>
				</div>
...
<div class="well well-small" style="margin-bottom: 2px"
	...
	<div ng-show="!collapsed.infoCliente">
		<form ng-submit="doSearchCliente()" class="form-search" style="margin: 0px">
			<fieldset>
				<button class="btn btn-info pull-right" type="submit"
				...
				<input style="margin-bottom: 2px" class="span4" type="text"
					placeholder="cognome nome" ng-model="nomeCognomeCliente"> <input
					style="margin-bottom: 2px" class="span3" type="text"
	...
	<div ng-show="collapsed.infoCliente">
		...
		<div ng-show="cliente == null">
			<i class="icon-plus pull-right" ng-click="collapsed.infoCliente = false"></i>
			<div class="row-fluid">
				<div class="span3" style="min-height: 0px">
					<b>Cliente: </b>
				</div>
...
<div class="well well-small" style="margin-bottom: 2px"
	...
	<div ng-show="!collapsed.infoPolizza">
		<form ng-submit="doSearchPolizza()" class="form-search" style="margin: 0px">
			<fieldset>
				<button class="btn btn-info pull-right" type="submit"
				...
				<input type="text" placeholder="numero" ng-model="numeroPolizza" class="span4" >
				<input type="text" placeholder="targa" ng-model="targa" class="span5" >
			</fieldset>
		</form>
	</div>
	<div ng-show="collapsed.infoPolizza">
		...
		<div ng-show="attivita.polizza == null">
			<i class="icon-plus pull-right" ng-click="collapsed.infoPolizza = false"></i>
			<div class="row-fluid">
				<div class="span3" style="min-height: 0px">
					<b>Polizza: </b>
				</div>
